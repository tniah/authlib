...
| `client_credentials`     | Client Credentials Grant (RFC 6749 §4.4). Confidential clients only; no refresh token. |
...
| `rfc6749/client_credentials`                         | [README](client_credentials/README.md)      |
