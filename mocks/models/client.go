...
func (_m *MockClient) GetAllowedScopes(scopes types.Scopes) types.Scopes {
	...
	var r0 types.Scopes
	if rf, ok := ret.Get(0).(func(types.Scopes) types.Scopes); ok {
		r0 = rf(scopes)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockClient_GetAllowedScopes_Call) Run(run func(scopes types.Scopes)) *MockClient_GetAllowedScopes_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockClient_GetAllowedScopes_Call) Return(_a0 types.Scopes) *MockClient_GetAllowedScopes_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockClient_GetAllowedScopes_Call) RunAndReturn(run func(types.Scopes) types.Scopes) *MockClient_GetAllowedScopes_Call {
	_c.Call.Return(run)
	return _c
}
