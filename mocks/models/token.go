...
func (_m *MockToken) GetScopes() []string {
	ret := _m.Called()
...
func (_c *MockToken_GetScopes_Call) Return(_a0 []string) *MockToken_GetScopes_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockToken_GetScopes_Call) RunAndReturn(run func() []string) *MockToken_GetScopes_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockToken) SetScopes(scopes []string) {
	_m.Called(scopes)
}
...
func (_c *MockToken_SetScopes_Call) Run(run func(scopes []string)) *MockToken_SetScopes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]string))
	})
	return _c
...
func (_c *MockToken_SetScopes_Call) RunAndReturn(run func([]string)) *MockToken_SetScopes_Call {
	_c.Call.Return(run)
	return _c
}
