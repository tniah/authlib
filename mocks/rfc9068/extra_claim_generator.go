...
func (_m *MockExtraClaimGenerator) Execute(grantType string, client models.Client, user models.User, scopes types.Scopes) (map[string]interface{}, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, models.Client, models.User, types.Scopes) (map[string]interface{}, error)); ok {
		return rf(grantType, client, user, scopes)
	}
	if rf, ok := ret.Get(0).(func(string, models.Client, models.User, types.Scopes) map[string]interface{}); ok {
	...
	if rf, ok := ret.Get(1).(func(string, models.Client, models.User, types.Scopes) error); ok {
...
func (_c *MockExtraClaimGenerator_Execute_Call) Run(run func(grantType string, client models.Client, user models.User, scopes types.Scopes)) *MockExtraClaimGenerator_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(models.Client), args[2].(models.User), args[3].(types.Scopes))
	})
	return _c
}
...
func (_c *MockExtraClaimGenerator_Execute_Call) RunAndReturn(run func(string, models.Client, models.User, types.Scopes) (map[string]interface{}, error)) *MockExtraClaimGenerator_Execute_Call {
	_c.Call.Return(run)
	return _c
}
