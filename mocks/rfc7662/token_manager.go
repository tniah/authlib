...
func (_m *MockTokenManager) QueryByToken(ctx context.Context, token string, hint string) (models.Token, error) {
...
func (_c *MockTokenManager_QueryByToken_Call) Run(run func(ctx context.Context, token string, hint string)) *MockTokenManager_QueryByToken_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTokenManager_QueryByToken_Call) RunAndReturn(run func(context.Context, string, string) (models.Token, error)) *MockTokenManager_QueryByToken_Call {
	_c.Call.Return(run)
	return _c
}
