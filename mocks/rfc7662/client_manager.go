...
func (_m *MockClientManager) Authenticate(r *http.Request, authMethods map[string]bool, endpointName string) (models.Client, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(*http.Request, map[string]bool, string) (models.Client, error)); ok {
		return rf(r, authMethods, endpointName)
	}
	if rf, ok := ret.Get(0).(func(*http.Request, map[string]bool, string) models.Client); ok {
	...
	if rf, ok := ret.Get(1).(func(*http.Request, map[string]bool, string) error); ok {
...
func (_c *MockClientManager_Authenticate_Call) Run(run func(r *http.Request, authMethods map[string]bool, endpointName string)) *MockClientManager_Authenticate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*http.Request), args[1].(map[string]bool), args[2].(string))
	})
	return _c
}
...
func (_c *MockClientManager_Authenticate_Call) RunAndReturn(run func(*http.Request, map[string]bool, string) (models.Client, error)) *MockClientManager_Authenticate_Call {
	_c.Call.Return(run)
	return _c
}
